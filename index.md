...
Relaynet is a decentralized technology with [technical specifications](https://specs.relaynet.network/) publicly available and [open source implementations](https://github.com/relaycorp). It was designed at Oxford and its development is now led by [Relaycorp](https://relaycorp.tech/). The initial implementation will be completed by Q4 2020 with funding from the [Open Technology Fund](https://www.opentech.fund/). [Learn more about Relaynet](./about).
